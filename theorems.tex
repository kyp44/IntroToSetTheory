...
\sol{
  ...
  \qproof{
    ...
    Hence, since we have shown that both $\suma \k_\a \leq \l \cdot \k$ and $\l \cdot \k \leq \suma \k_\a$, it follows from the Cantor-Bernstein Theorem that $\suma \k_\a = \l \cdot \k$ as desired.
  }
}
