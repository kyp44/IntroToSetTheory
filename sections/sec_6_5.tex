...
\sol{
  ...
  \qproof{
    \bicproof{
      ...
      Suppose that $\b+1 < \a$ for every $\b < \a$.
...
\qproof{
  \bicproof{
    ...
    Suppose that $\a + n < \b + n$ for ordinals $\a$ and $\b$ and natural number $n$.
...
\sol{
  ...
  \qproof{
    \bicproof{
      Suppose that $\a = \w \cdot n$ for natural number $n$.
      ...
      Now suppose that $\a$ is a limit ordinal and $\a < \w^2$.
  ...
  \qproof{
    \bicproof{
      Suppose that $\a = \w \cdot n + k$ for natural numbers $n$ and $k$.
      We then have
      \ali{
...
\sol{
  ...
  \qproof{
    \bicproof{
      We show this by transfinite induction on $\a_2$.
      ...
      For this we assume that $\b \cdot \a_1 < \b \cdot \a_2$.
  ...
  \qproof{
    ...
    \bicproof{
      We prove this part by contrapositive, so suppose that $\a_1 \neq \a_2$.
      ...
      If $\a_1 = \a_2$ then we trivially have $\b \cdot \a_1 = \b \cdot \a_2$.
    }
  }
}
...
\sol{
  ...
  \qproof{
    \bicproof{
      Suppose to the contrary that not every limit ordinal is equal to $\w \cdot \b$ for some $\b$.
      ...
      Suppose that $\a = \w \cdot \b$ for some ordinal $\b$.
...
\sol{
  ...
  \iffalse
    ...
    \qproof{
      \bicproof{
        Suppose that $\a$ has a greatest element $\b$.
        ...
        Suppose that $\a$ is a successor ordinal, in  particular that $\a = \b+1 = \b \cup \braces{\b}$ for an ordinal $\b$.
        Consider any $x \in \a$.
