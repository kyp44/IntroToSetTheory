...
\sol{
  \qproof{
    \bicproof{
      Suppose that $X$ is a transitive set and consider any $x \in X$.
      Then $x \ss X$ since $X$ is transitive.
      Thus $x \in \pset{X}$ so that, since $x$ was arbitrary, $X \ss \pset{X}$.
    }
    {
      Now suppose that $X \ss \pset{X}$ and consider any $x \in X$.
...
\sol{
  \qproof{
    \bicproof{
      Suppose that $X$ is transitive and consider any $y \in \bigcup X$.
      ...
      Now suppose that $\bigcup X \ss X$ and consider any $x \in X$.
...
\sol{
  \qproof{
    \bicproof{
      Suppose that $n$ is a natural number and consider any nonempty subset $A$ of $n$.
